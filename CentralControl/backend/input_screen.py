...
async def create_project(data: ParaData):
    """
    Creates a new screening project using the provided parameters.
...
def nlp2space(data: NlpSpaceData):
    """
    Converts natural language description of the screening space into a structured format.

    Parameters:
    - data (NlpSpaceData): The input data containing natural language description and action steps.

    Returns:
    - dict: The structured space and modified action steps.
    """
    nlp = data.nlp
    action = data.action
...
def nlp2action(data: NlpData):
    """
    Converts natural language description of an experimental procedure into structured action steps.

    Parameters:
    - data (NlpData): The input data containing the natural language description of the procedure.

    Returns:
    - dict: The structured action steps.
    """
    nlp = data.nlp
...
def nlp2code(data: NlpData):
    """
    Converts natural language description of an experimental procedure into Python code for an Opentrons OT-2 protocol.

    Parameters:
    - data (NlpData): The input data containing the natural language description of the procedure.

    Returns:
    - str: The generated Python code for the OT-2 protocol.
    """
    nlp = data.nlp
